...
1. **✅ WHAT’S WORKING** — 2-3 specific things performing well with exact numbers
1. **⚠️ PROBLEMS** — 2-3 specific issues or underperformers with exact numbers
1. **💡 ACTION ITEMS** — 3 concrete things the owner should do THIS WEEK based on the data
1. **💰 MONEY INSIGHT** — one key financial insight (e.g. best/worst lead source ROI, most profitable move type)
